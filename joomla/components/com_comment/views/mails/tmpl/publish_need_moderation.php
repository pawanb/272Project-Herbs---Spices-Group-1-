...
?>
<p>
<?php echo JText::sprintf('COM_COMMENT_NEEDS_MODERATION_NOTIFY_PUBLISH_MESSAGE_ON_SITE_MODERATOR', Juri::root(), JFactory::getConfig()->get('sitename')) ?> <br />
	<b>
...
<p>
<?php echo JText::sprintf('COM_COMMENT_NEEDS_MODERATION_NOTIFY_TO_VIEW_THE_COMMENT_CLICK_HERE', $link); ?>
</p>
<p>
