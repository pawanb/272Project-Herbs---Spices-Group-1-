		...
		<table class="table table-striped">
			...
			<tbody>
				<tr>
					...
					<td><strong><?php echo JText::_( 'COM_SECURITYCHECK_INSTALLED' ); ?></strong>
					<img src="../media/com_securitycheck/images/ok_small.png" title="<?php echo JText::_( 'COM_SECURITYCHECK_INSTALLED' ); ?>" alt="<?php echo JText::_( 'COM_SECURITYCHECK_INSTALLED' ); ?>"></td>
				</tr>
				<tr class="row0">
				...
				?>
						<td><strong><?php echo JText::_( 'COM_SECURITYCHECK_NOT_INSTALLED' ); ?></strong>
						<img src="../media/com_securitycheck/images/error_small.png" title="<?php echo JText::_( 'COM_SECURITYCHECK_NOT_INSTALLED' ); ?>" alt="<?php echo JText::_( 'COM_SECURITYCHECK_NOT_INSTALLED' ); ?>"></td>
				<?php
					}
				?>
				</tr>				
...
?>
	...
	<table class="table table-striped">
		...
		<tbody>
			<tr>
				<td colspan="2">Securitycheck <?php echo JText::_( 'COM_SECURITYCHECK_COMPONENT' ); ?></td>
				<td><strong><?php echo JText::_( 'COM_SECURITYCHECK_UNINSTALLED' ); ?></strong>
			</tr>
			<tr class="row0">
				<td class="key" colspan="2">Securitycheck <?php echo JText::_( 'COM_SECURITYCHECK_PLUGIN' ); ?> </td>
				<?php 
