							...
							new Request({
								...
								onSuccess: function(responseText){
									...
									if (percent == 100) {
										...
										document.getElementById('buttonwrapper').innerHTML = '<?php echo ('<button class="btn btn-success" type="button" onclick="window.location.reload();"><i class="icon-repeat icon-white"></i>' . JText::_( 'COM_SECURITYCHECK_FILEMANAGER_REFRESH_BUTTON' ) . '</button>');?>';
									}
								},
