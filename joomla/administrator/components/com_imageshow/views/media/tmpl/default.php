...
<div class="jsn-predefine-bg-selection">
	...
	<fieldset class="jsn-url-properties" style="<?php echo ($act =='custom' || $act =='watermark' || $act =='showlist')? '': 'display:none;';?>">
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td nowrap="nowrap">
					<form action="<?php echo JURI::base(); ?>index.php?option=com_imageshow&amp;controller=media&amp;task=upload&amp;tmpl=component&amp;<?php echo $this->session->getName().'='.$this->session->getId(); ?>&amp;pop_up=1&amp;<?php echo JSession::getFormToken();?>=1" style="<?php echo ($act =='custom' || $act =='watermark' || $act =='showlist')? '': 'display:none;';?>" id="uploadForm" method="post" enctype="multipart/form-data">
	...
	<div class="jsn-image-folder-list">
		<iframe id="imageframe" name="imageframe"
			src="index.php?option=com_imageshow&amp;controller=media&amp;view=imageslist&amp;act=<?php echo $act; ?>&amp;tmpl=component&amp;folder=<?php echo $this->state; ?>"></iframe>
	</div>
	<form action="index.php" id="imageForm" method="post"
		enctype="multipart/form-data">
